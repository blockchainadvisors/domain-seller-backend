...
export class FullSchema1731446100043 implements MigrationInterface {
  name = 'FullSchema1731446100043';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "domain" ("current_highest_bid" numeric(18,2), "status" character varying NOT NULL, "description" character varying, "url" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_27e3ec3ea0ae02c8c5bceab3ba9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "auction" ("min_increment" numeric(18,2) NOT NULL, "reserve_price" numeric(18,2) NOT NULL, "end_time" TIMESTAMP NOT NULL, "start_time" TIMESTAMP NOT NULL, "status" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "domain_id" uuid NOT NULL, CONSTRAINT "REL_881d398e297dca8d2cacf7187b" UNIQUE ("domain_id"), CONSTRAINT "PK_9dc876c629273e71646cf6dfa67" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
